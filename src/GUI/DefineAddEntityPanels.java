...
public class DefineAddEntityPanels extends JPanel
{
    ...
    public DefineAddEntityPanels()
    {
        ...
        {
            ArrayList<Pair<Entity, String>> entityPanels = new ArrayList<>();
            ...
            for (int i=0; i<checkBoxes.size(); ++i)
            {
                ...
                for (int j=0; j<arr.length; ++j)
                {
                    if (arr[j].isSelected())
                    {
                        ...
                        {
                            case "1": entityPanels.add(new Pair(entityList.get(i),"add"));
                                      break;
                            case "2": entityPanels.add(new Pair(entityList.get(i),"update"));
                                      break;
                            case "3": entityPanels.add(new Pair(entityList.get(i),"delete"));
                                      break;
                            case "4": entityPanels.add(new Pair(entityList.get(i),"view"));
                                      break;
                        }
                    }
                }
