...
public class HomePageFrame extends JFrame
{
    ...
    private void createView()
    {
        ...
        ProjectLandingPage lPage = new ProjectLandingPage();
    ...
    public static void changeRootPanel(int code)
    {
        switch (code)
        {
            case 1: rootCardLayout.show(rootPanel,"LoginModule");
                    break;
            case 2: rootCardLayout.show(rootPanel,"System Menu");
                    break;
            case 3: rootCardLayout.show(rootPanel,"Create System");
                    break;
        }
    }
